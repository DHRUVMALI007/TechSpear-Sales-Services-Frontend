    ...
    <div className="p-6">
      ...
      {selectedTransaction && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center p-4">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-xl w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl relative m-4">
            {/* ✖ Close Button */}
            <button
            ...
            {/* 🏷️ Modal Title */}
            <h3 className="text-xl font-bold text-gray-800 mb-4 border-b pb-2">Transaction Details</h3>
